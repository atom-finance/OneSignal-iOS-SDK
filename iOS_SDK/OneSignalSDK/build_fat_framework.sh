...
XCODEBUILD_OLDEST_SUPPORTED=/Applications/Xcode_11.7.app/Contents/Developer/usr/bin/xcodebuild
XCODEBUILD_12=/Applications/Xcode.app/Contents/Developer/usr/bin/xcodebuild
...
$XCODEBUILD_12 -configuration ${BUILD_CONFIG} ARCHS="x86_64h" VALID_ARCHS="x86_64h" -destination 'platform=macOS,variant=Mac Catalyst' MACH_O_TYPE=${BUILD_TYPE} -project ${BUILD_PROJECT} -scheme ${BUILD_SCHEME} SYMROOT="${DERIVED_DATA_RELATIVE_DIR}/"
